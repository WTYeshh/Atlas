            ...
            ListView(
              ...
              children: [
                ...
                _buildThemeInventoryItem(
                  ...
                  rarity: 'Common',
                  isUnlocked: scholarState.unlockedThemes.contains('ocean_blue'),
                  isActive: scholarState.selectedTheme == 'ocean_blue',
                  onUse: () => scholarNotifier.selectTheme('ocean_blue'),
                ),
                _buildThemeInventoryItem(
                  context: context,
                  ...
                  rarity: 'Common',
                  isUnlocked: scholarState.unlockedThemes.contains('cherry_blossom'),
                  isActive: scholarState.selectedTheme == 'cherry_blossom',
                  onUse: () => scholarNotifier.selectTheme('cherry_blossom'),
                ),
                _buildThemeInventoryItem(
                  context: context,
                  themeKey: 'warm_sepia',
                ...
                _buildThemeInventoryItem(
                  context: context,
                  themeKey: 'lava_red',
                  displayName: 'Lava Red 🔥',
                  rarity: 'Rare',
                  isUnlocked: scholarState.unlockedThemes.contains('lava_red'),
                  isActive: scholarState.selectedTheme == 'lava_red',
                  onUse: () => scholarNotifier.selectTheme('lava_red'),
                ),
                _buildThemeInventoryItem(
                  context: context,
                  themeKey: 'arctic_ice',
                  ...
                  rarity: 'Rare',
                  isUnlocked: scholarState.unlockedThemes.contains('arctic_ice'),
                  isActive: scholarState.selectedTheme == 'arctic_ice',
                  onUse: () => scholarNotifier.selectTheme('arctic_ice'),
                ),
                _buildThemeInventoryItem(
                  context: context,
                  ...
                  rarity: 'Rare',
                  isUnlocked: scholarState.unlockedThemes.contains('sage_minimal'),
                  isActive: scholarState.selectedTheme == 'sage_minimal',
                  onUse: () => scholarNotifier.selectTheme('sage_minimal'),
                ),
                _buildThemeInventoryItem(
                  context: context,
                ...
                _buildThemeInventoryItem(
                  ...
                  rarity: 'Epic',
                  isUnlocked: scholarState.unlockedThemes.contains('midnight_indigo'),
                  isActive: scholarState.selectedTheme == 'midnight_indigo',
                  onUse: () => scholarNotifier.selectTheme('midnight_indigo'),
                ),
                _buildThemeInventoryItem(
                  context: context,
                  themeKey: 'steel_noir',
                  displayName: 'Steel Noir ⬛',
                  rarity: 'Epic',
                  isUnlocked: scholarState.unlockedThemes.contains('steel_noir'),
                  isActive: scholarState.selectedTheme == 'steel_noir',
                  onUse: () => scholarNotifier.selectTheme('steel_noir'),
                ),
                _buildThemeInventoryItem(
                  context: context,
                ...
                _buildThemeInventoryItem(
                  ...
                  rarity: 'Legendary',
                  isUnlocked: scholarState.unlockedThemes.contains('galaxy_purple'),
                  isActive: scholarState.selectedTheme == 'galaxy_purple',
                  onUse: () => scholarNotifier.selectTheme('galaxy_purple'),
                ),
              ],
            ),
            const SizedBox(height: 20),
