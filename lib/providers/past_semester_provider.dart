...
class PastSemesterNotifier extends StateNotifier<List<PastSemesterModel>> {
  ...
  Future<String> downloadSemesterReport(PastSemesterModel sem) async {
    ...
    buffer.writeln('========================================');
    buffer.writeln('      ATLAS ACADEMIC SEMESTER REPORT     ');
    buffer.writeln('========================================');
    ...
    final fileName = 'Atlas_${sem.name.replaceAll(' ', '_')}_Report.txt';
    ...
    if (Platform.isAndroid) {
      ...
      final downloadsPath = Directory('/storage/emulated/0/Download/AtlasApp');
      try {
